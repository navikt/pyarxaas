...
def anonymization_metrics():
    metrics = {"anonymizationStatus": "ANONYMIZED"}
    return AnonymizeResult.AnonymizationMetrics(metrics)


def risk_profile() -> RiskProfile:
    test_metric = {"reIdentificationRisk": {
        "measure_value": "[%]",
    ...
    return RiskProfile(test_metric)
