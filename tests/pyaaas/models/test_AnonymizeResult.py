...
class AnonymizeResultTest(unittest.TestCase):
    ...
    def test_init(self):
        AnonymizeResult(self.test_dataset, self.test_risk_profile, self.test_anon_metrics)

    def test_equaltiy(self):
        ar1 = AnonymizeResult(self.test_dataset, self.test_risk_profile, self.test_anon_metrics)
        ar2 = AnonymizeResult(self.test_dataset, self.test_risk_profile, self.test_anon_metrics)
    ...
    def test_dataset(self):
        ar = AnonymizeResult(self.test_dataset, self.test_risk_profile, self.test_anon_metrics)
        dataset = ar.dataset
    ...
    def test_create_from_response_payload(self):
        ar1 = AnonymizeResult._from_response(self.test_dataset, self.test_risk_profile, self.raw_metrics)
        ar2 = AnonymizeResult(self.test_dataset, self.test_risk_profile, self.test_anon_metrics)
        self.assertEqual(ar1, ar2)
